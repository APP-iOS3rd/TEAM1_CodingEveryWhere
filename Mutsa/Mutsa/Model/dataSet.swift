...
let teacherData: [TeacherData] = [
    ...
    TeacherData(name: "유민영", image: "you", position: "Lecturer", oneSentence: "개굴", history: "• 현) P사 대표 & M사 개발팀 총괄 부장 겸임\n • 전) B사 공동창업자, 부사장\n • 전) S사 전략기획팀 디자이너, 개발자\n • 전) A사 디지털디자인연구소 연구원, 디자이너\n")
]
...
let mentorData: [MentorData] = [
    ...
    MentorData(name: "리이오", image: "leo", position: "Mentor", oneSentence: "단순히 지식을 배우는 것이 아닌 활용할 수 있는 방법을 알려주고 싶습니다.", history: "• 와디즈 IOS 개발\n •  유투브 '개발자리' 운영\n • 레츠스위프트, 아디오스, KWDC 등 커뮤니티 활동", gitUrl: "https://github.com/M1zz", blogUrl: "http://dev200ok.blogspot.com"),
